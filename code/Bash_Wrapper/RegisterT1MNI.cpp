...
int main(int argc, char **argv)
{
    ...
    {        
        printf("Usage:\n\n");
        printf("RegisterT1MNI input.nii MNI_template.nii [options]\n\n");
        printf("Options:\n\n");
        ...
        printf("-output                    Set output filename (default input_MNI.nii) \n");
        printf("-quiet                     Don't print anything to the terminal (default false) \n");
        printf("-debug                     Get additional debug information (default no). Warning: This will use a lot of extra memory! \n");
        printf("\n\n");
    ...
    if (inputMNI == NULL)
    {
        printf("Could not open MNI file!\n");
        return -1;
    }
    ...
    {
        printf("\n\nWARNING: It is not recommended to use 8 as a lowest scale for a 2 mm template.\n\n");   
    }
    ...
    */
    ...
    WriteNifti(outputNifti,h_Interpolated_T1_Volume,"_interpolated_to_MNI",ADD_FILENAME,DONT_CHECK_EXISTING_FILE);
    WriteNifti(outputNifti,h_Aligned_T1_Volume,"_MNI_linear",ADD_FILENAME,DONT_CHECK_EXISTING_FILE);
    WriteNifti(outputNifti,h_Aligned_T1_Volume_NonParametric,"_MNI_nonlinear",ADD_FILENAME,DONT_CHECK_EXISTING_FILE);
