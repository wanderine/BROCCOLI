...
do
	...
	#time mcflirt -in ${data_directory}/cambridge_rest_subject_${subject}_with_random_motion_2percent_noise.nii -refvol 0  -plots -out ${results_directory}/FSL_motion_corrected_subject${subject}_random_motion_2percent_noise.nii
