...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    double          *h_T1_MNI_Registration_Parameters_double, *h_EPI_T1_Registration_Parameters_double, *h_Motion_Parameters_double;
    float           *h_T1_MNI_Registration_Parameters, *h_EPI_T1_Registration_Parameters, *h_Motion_Parameters;
    ...
    int             NUMBER_OF_REGRESSORS, NUMBER_OF_CONTRASTS;
    ...
    h_X_GLM_double =  (double*)mxGetData(prhs[25]);
    h_xtxxt_GLM_double =  (double*)mxGetData(prhs[26]);
    h_Contrasts_double = (double*)mxGetData(prhs[27]);
    h_ctxtxc_GLM_double = (double*)mxGetData(prhs[28]);
    ...
    SMOOTHING_FILTER_LENGTH = ARRAY_DIMENSIONS_SMOOTHING_FILTER[0];
    ...
    plhs[6] = mxCreateNumericArray(NUMBER_OF_DIMENSIONS,ARRAY_DIMENSIONS_OUT_MOTION_PARAMETERS,mxDOUBLE_CLASS, mxREAL);
    h_Motion_Parameters_double = mxGetPr(plhs[6]);  
    ...
    plhs[7] = mxCreateNumericArray(NUMBER_OF_DIMENSIONS,ARRAY_DIMENSIONS_OUT_MOTION_CORRECTED_FMRI_VOLUMES,mxDOUBLE_CLASS, mxREAL);
    h_Motion_Corrected_fMRI_Volumes_double = mxGetPr(plhs[7]);          
    ...
    plhs[8] = mxCreateNumericArray(NUMBER_OF_DIMENSIONS,ARRAY_DIMENSIONS_OUT_SMOOTHED_FMRI_VOLUMES,mxDOUBLE_CLASS, mxREAL);
    h_Smoothed_fMRI_Volumes_double = mxGetPr(plhs[8]);          
    ...
    h_Residual_Variances                = (float *)mxMalloc(MNI_DATA_SIZE);
