function [aligned_T1_volume registration_parameters] = perform_T1_MNI_registration_CPU(T1,MNI,f1,f2,f3,number_of_iterations)

filter_size = size(f1,1);

reference_volume = MNI;
...
[aligned_T1_volume,registration_parameters] = Phasebased_3D_registration_FFT(MNI,T1,quadrature_responses_reference_volume,quadrature_filters,x,y,z,number_of_iterations,filter_size);    
